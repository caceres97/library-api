...
var MigrateTables = /** @class */ (function () {
    function MigrateTables() {
        var _this = this;
        this.up = function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, user_model_1.User.sync()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, genre_model_1.Genre.sync()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, author_model_1.Author.sync()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, book_model_1.Book.sync()];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, copy_model_1.Copy.sync()];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, rent_model_1.Rental.sync()];
                    case 6:
                        _a.sent();
